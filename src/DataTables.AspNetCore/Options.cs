...
namespace DataTables.AspNetCore
{
    ...
    public class Options : IOptions
    {
        ...
        /// </summary>
        public Options() : this(10, true, false, false, new CamelCaseRequestNameConvention(), new CamelCaseResponseNameConvention())
        {
        }
        ...
        /// <param name="enableRequestAdditionalParameters">
        ///     Indicates if additional parameters resolution will be enabled for for
        ///     request by default.
        /// </param>
        /// <param name="enableResponseAdditionalParameters">
        ///     Indicates if additional parameters will be sent to the response by
        ///     default.
        /// </param>
        ...
        public Options(int defaultPageLength, bool enableDrawValidation, bool enableRequestAdditionalParameters, bool enableResponseAdditionalParameters,
            IRequestNameConvention requestNameConvention, IResponseNameConvention responseNameConvention)
        {
        ...
        {
            RequestNameConvention = new HungarianNotationRequestNameConvention();
            ResponseNameConvention = new HungarianNotationResponseNameConvention();
            return this;
        }
    }
}